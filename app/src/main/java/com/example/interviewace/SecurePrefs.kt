...
object SecurePrefs {
    ...
    fun saveMoodTime(context: Context, moodTime: String, bot: String){
        val botString = when(bot){
            "Audrie" -> PREFS_MOOD_TIME_B1
            "Camille" -> PREFS_MOOD_TIME_B2
            "Elara" -> PREFS_MOOD_TIME_B3
            "Kyoko" -> PREFS_MOOD_TIME_B4
            "Mandy" -> PREFS_MOOD_TIME_B5
            "Manuela" -> PREFS_MOOD_TIME_B6
            "Maxine" -> PREFS_MOOD_TIME_B7
            "Stephanie" -> PREFS_MOOD_TIME_B8
            "Christine" -> PREFS_MOOD_TIME_B9
            "Jade" -> PREFS_MOOD_TIME_B10
            "Kaede" -> PREFS_MOOD_TIME_B11
            "Pamela" -> PREFS_MOOD_TIME_B12
            else -> ""
        }
        val sharedPrefs = getEncryptedSharedPreferences(context)
        sharedPrefs.edit().putString(botString, moodTime).apply()
    }

    fun getMoodTime(context: Context, bot: String): String{
        val botString = when(bot){
            "Audrie" -> PREFS_MOOD_TIME_B1
            "Camille" -> PREFS_MOOD_TIME_B2
            "Elara" -> PREFS_MOOD_TIME_B3
        ...
        val sharedPrefs = getEncryptedSharedPreferences(context)
        return sharedPrefs.getString(botString, null)?: ""
    }

    fun saveMood(context: Context, mood: String, bot: String){
        val botString = when(bot){
            "Audrie" -> PREFS_MOOD_B1
            "Camille" -> PREFS_MOOD_B2
            "Elara" -> PREFS_MOOD_B3
            "Kyoko" -> PREFS_MOOD_B4
            "Mandy" -> PREFS_MOOD_B5
            "Manuela" -> PREFS_MOOD_B6
            "Maxine" -> PREFS_MOOD_B7
            "Stephanie" -> PREFS_MOOD_B8
            "Christine" -> PREFS_MOOD_B9
            "Jade" -> PREFS_MOOD_B10
            "Kaede" -> PREFS_MOOD_B11
            "Pamela" -> PREFS_MOOD_B12
            else -> ""
        }
        val sharedPrefs = getEncryptedSharedPreferences(context)
        sharedPrefs.edit().putString(botString, mood).apply()
    }

    fun getMood(context: Context, bot: String): String{
        val botString = when(bot){
            "Audrie" -> PREFS_MOOD_B1
            "Camille" -> PREFS_MOOD_B2
            "Elara" -> PREFS_MOOD_B3
